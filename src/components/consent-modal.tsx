    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
      ...
      >
        ...
        <div className="space-y-5 font-body text-bea-charcoal leading-relaxed">
          <p>
            Bea is a quiet presence in your home. With your permission, Bea will listen during the times your whānau chooses, so she can understand the rhythm of your family and offer reflections that help.
          </p>
          <p>
            When Bea is on, she records conversations and turns them into transcripts. These are stored privately for your whānau and used to notice patterns, suggest moments of connection, and check in with each of you.
          </p>
          <p>
