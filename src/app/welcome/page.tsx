...
export default async function WelcomePage() {
  ...
  return (
    // Left-aligned, deeply spaced, matching the Home screen layout
    <div className="flex flex-col flex-1 justify-center pb-12 md:pb-20 animate-fade-in">
      ...
      <div className="space-y-6 md:space-y-8 max-w-sm">
        ...
        {/* H1 signals a pause. No exclamation marks. No tech phrasing. */}
        ...
        {/* Generous spacing pushes the utility button away from the emotional text */}
